...
<Project Type="Project" LVVersion="19008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Project Documentation" Type="Folder">
			...
			<Item Name="Account Details" Type="Folder">
		...
		<Item Name="Type Definitions" Type="Folder">
			...
			<Item Name="Read &amp; Write File.ctl" Type="VI" URL="../controls/Read &amp; Write File.ctl"/>
			<Item Name="Account Details.ctl" Type="VI" URL="../controls/Account Details.ctl"/>
			<Item Name="Left Right Menu.ctl" Type="VI" URL="../controls/Left Right Menu.ctl"/>
			<Item Name="Set_Function.ctl" Type="VI" URL="../controls/Set_Function.ctl"/>
			<Item Name="Replace Request.ctl" Type="VI" URL="../controls/Replace Request.ctl"/>
			<Item Name="Message Selector.ctl" Type="VI" URL="../controls/Message Selector.ctl"/>
			<Item Name="Message_type.ctl" Type="VI" URL="../controls/Message_type.ctl"/>
		</Item>
		<Item Name="SubVIs" Type="Folder">
			<Item Name="Read_Write File.vi" Type="VI" URL="../SubVIs/Read_Write File.vi"/>
			<Item Name="Message Update.vi" Type="VI" URL="../SubVIs/Message Update.vi"/>
			<Item Name="Get Menus.vi" Type="VI" URL="../SubVIs/Get Menus.vi"/>
			<Item Name="Enable Menus.vi" Type="VI" URL="../SubVIs/Enable Menus.vi"/>
			<Item Name="Set Function.vi" Type="VI" URL="../SubVIs/Set Function.vi"/>
			<Item Name="Message Maker.vi" Type="VI" URL="../SubVIs/Message Maker.vi"/>
			<Item Name="Enter_Function.vi" Type="VI" URL="../SubVIs/Enter_Function.vi"/>
			<Item Name="PIN Verification.vi" Type="VI" URL="../SubVIs/PIN Verification.vi"/>
		</Item>
		<Item Name="Controls" Type="Folder">
			<Item Name="ATM Action.ctl" Type="VI" URL="../controls/ATM Action.ctl"/>
			<Item Name="Message Type.ctl" Type="VI" URL="../controls/Message Type.ctl"/>
		</Item>
		<Item Name="Automatic Teller Machine (ATM).vi" Type="VI" URL="../../../../Users/PK_Singh/Desktop/cld_sample_exams_english/cld_sample_exams_english/ATM (100928C-01)/USB Template (LV 8.6)/Automatic Teller Machine/Automatic Teller Machine (ATM).vi"/>
		<Item Name="SubVI.lvlib" Type="Library" URL="../../SubVIs/SubVI.lvlib"/>
		<Item Name="Coffee.vi" Type="VI" URL="../../Coffee.vi"/>
